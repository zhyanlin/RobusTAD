...
def forwardPassdiag_i(diag,i,n,data,S,K,pairS,T,boundaries,lefts,rights,minDelta,minRatio,maxTAD,minTAD):
            j = i+diag
            if j>=n:
                return
...
def assembly(data, lefts, rights,minDelta=0.3,minRatio=1.1,resol=5000,maxTAD=3000000,minTAD=30000,distance=50000):
    ...
    for diag in tqdm(range(2,n)):
        ...
        delayed(forwardPassdiag_i)(diag,i,n,data,S,K,pairS,T,boundaries,lefts,rights,minDelta,minRatio,maxTAD,minTAD) for i in range(n))
